...
**Status:** ⏳ open — regression test in `02-quality-system.md`, fix planned for Task 3.
...
|---|---|---|---|---|
| F1 | P1 | Built wrong | Overrides destroyed on regeneration | Open |
| F2 | P1 | Missing spec | Zero test coverage | Open |
| F3 | P1 | Missing spec / built wrong | Coverage state threshold mismatch | Open |
| F4 | P0 | Built wrong | Invite link points at API port, not web app | Open |
| F5 | P1 (conditional) | Built wrong / missing spec | Hardware check: persistent slow network permanently blocks start; no timeout; third-party false negatives | Open |
...
| F8+ | — | — | (continue adding from live walkthrough) | — |
